#!/usr/bin/env python3
# VENDORED INTO landing-audit on 2026-09-02.
# Upstream: ~/projects/archeion-skills-library/content/skills/seo-audit/scripts/seo_checker.py
# Vendored (not called in place) so the skill works on a machine that does not
# have the upstream skills installed. Stdlib only; run with python3, never python.
# Its own docs upstream document flags that do not exist — trust --help, not prose.
"""
